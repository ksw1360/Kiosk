...
namespace Kiosk.Popup
{
    public partial class PersonInfoRule : Form
    {
        ...
        {
            /*
            if (MessageBox.Show(this, "저장하시겠습니까?", "", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                if (UPDATE_PRIVACY(TxtPrivacy.Text))
                {
                    MessageBox.Show(this, "저장되었습니다.", "", MessageBoxButtons.OK);
